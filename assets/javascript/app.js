    ...
    window.addEventListener('load', function() {
      ...
      var validation = Array.prototype.filter.call(forms, function(form) {
        form.addEventListener('submit', function(event) {
          ...
          //Initialize Firebase
          var config = {
            apiKey: "AIzaSyC_VVMHqx0GW7PijbIkeqAuy52l9UiUdCk",
            authDomain: "trainschedule-78912.firebaseapp.com",
            databaseURL: "https://trainschedule-78912.firebaseio.com",
            projectId: "trainschedule-78912",
            storageBucket: "trainschedule-78912.appspot.com",
            messagingSenderId: "615237039096"
          };
